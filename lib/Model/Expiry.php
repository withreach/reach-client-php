...
class Expiry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets month
     *
     * @param string|null $month Month the card expires in. Returned as 2-character numeric.
     *
     * @return self
     */
     ...
     * Sets year
     *
     * @param string|null $year Year the card expires. Returned as a 4-character numeric.
     *
     * @return self
     */

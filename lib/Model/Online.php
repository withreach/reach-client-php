 ...
 */
class Online implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'Online';
     ...
     * Sets locale
     *
     * @param string|null $locale Locale for redirects. May need to be customized to a specific payment type.
     *
     * @return self
     */
